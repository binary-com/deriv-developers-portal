...
# This is a simple example of buying a contract where we do not check first if
...
# - Copy and save this file to a new directory as `buy_contract.py`.
...
def on_message(ws, message):
    ...
    # Our buy request was successful lets print the results.
