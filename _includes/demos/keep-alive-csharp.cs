 ...
 * - Run `dotnet new console --output proposal_keep_alive` In a dir on your computer
 * - Then run `dotnet add proposal_keep_alive package Newtonsoft.Json` 
 * - Change to the new proposal_keep_alive dir and edit the `Program.cs` file, paste in the contents of this script and save.
 * - Run `dotnet run --project proposal_keep_alive ` in the parent dir.  
 *
 */
