 ...
 * - Run `dotnet new console --output ticks` In a dir on your computer
 * - Then run `dotnet add ticks package Newtonsoft.Json` 
 * - Change to the new ticks dir and edit the `Program.cs` file, paste in the contents of this script and save.
