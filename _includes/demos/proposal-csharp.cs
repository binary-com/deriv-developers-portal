 ...
 * - Run `dotnet new console --output proposal` In a dir on your computer
 * - Then run `dotnet add proposal package Newtonsoft.Json` 
 * - Change to the new proposal dir and edit the `Program.cs` file, paste in the contents of this script and save.
 * - Run `dotnet run --project proposal ` in the parent dir.  
 *
 */
