      ...
      <div className="app-registration-logged-in">
        ...
        <div className="manage-apps">
          <div className="manage-apps-table">
            ...
            {/* display message "To modify your details please go back to the form and update your applicaton." when data-state empty */}
          ...
          <dialog id="delete_app_dialog" className="dialog-wrapper">
            <div className="dialog dialog-delete">
              ...
              <div className="dialog-body dialog-body-delete">
                ...
                {/* Add "Delete app" bold text in the center */}
                <h3>Delete app</h3>
                <div className="dialog-question">Are you sure you want to delete this app?</div>
              </div>
              <div className="dialog-footer">
          ...
          {/* create a modal with a svg, header and text.  */}
