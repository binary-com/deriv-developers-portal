...
export default function ApiGuide() {
  ...
  return (
    <div className={styles.apiGuide} is_feature data-id="api-guide">
      {!isMobile && <Navigator />}
      <div className={styles.apiGuideContent}>
        ...
        <div className={styles.textBlock}>
          ...
          <p>
            ...
            <a href="https://deriv.com/terms-and-conditions">
              terms and conditions
            </a>{" "}
            and{" "}
            <a href="https://deriv.com/tnc/business-partners-general-terms.pdf">
              copyright
            </a>
            .
          </p>
          <p>
            ...
            <a href="mailto:api-support@deriv.com">email</a>.
          </p>
        </div>
        <div className={styles.textBlock}>
          ...
          <p>
            ...
            visit this <a href="/docs/">guide</a>.
          </p>
          <h2 id="json">JSON</h2>
          <p>
        ...
        <p>
          ...
          <a href="https://app.deriv.com/account/api-token">here</a>, along with
        ...
        <p>
          ...
          <Link to="/api-explorer">API Explorer</Link> as well.
        </p>
        <p>
        ...
        <p>
          ...
          of examples on the <Link to="/docs/">quick start page</Link>.
        </p>
        <p>
        ...
        <ul>
          ...
          <li>
            ...
            <b>Proposal Open Contract</b> response to see when the contract is
            finished. Once the contract is finished, you can check the{" "}
            <b>“status”</b> attribute to see if the contract has been won or
            lost.
          </li>
        </ul>
