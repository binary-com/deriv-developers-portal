        ...
        <div className={styles.apiGuide} data-id='api-guide'>
            ...
            <div className={styles.apiGuideContent}>
                ...
                <div className={styles.textBlock}>
                    ...
                    <p>
                        The Deriv API allows you to perform nearly all functions of the Deriv platforms, since they
                        share the same API. For our CFD platforms (Deriv MT5 and Deriv X), the API functionality is only
                    ...
                    <ul>
                        <li>
                            <p>
                                ...
                                <a href='https://deriv.com/partners/affiliate-ib/' rel='noreferrer' target='_blank'>
                                    here
                                </a>
                                .{' '}
                            </p>
                    ...
                    <ul className={styles.markupCalc}>
                        <p>
                            To get a payout of <b>2 USD:</b>
                        </p>
                        <li>
                            Client stake without markup = <b>1.07 USD</b>
                        </li>
                    ...
                    <p>
                        ...
                        <a href='https://deriv.com/tnc/business-partners-general-terms.pdf'>copyright</a>.
                    </p>
                    <p>
                        Should you run into any difficulties using it or if you need assistance, please contact us via
                        one of our support forums or via <a href='mailto:api-support@deriv.com'>email</a>.
                    </p>
                </div>
                <div className={styles.textBlock}>
                    <h2 id='technical-specifications-of-the-deriv-api'>Technical specifications of the Deriv API</h2>
                    <p>
                        It is only possible to communicate with the Deriv API using WebSockets; it does not support
                        other protocols. Any data passed to the Deriv API should be in JSON format, while the
                        comprehensive all-in-one client library is available in JavaScript and Python.
                    </p>
                    <h3 id='websockets'>WebSockets</h3>
                    <p>
                        The WebSockets protocol is an advanced version of the communication channel that is available in
                        all popular programming languages. It allows the server to send information to the client and
                        maintain the connection without the client requesting it every time.
                    </p>
                    <p>
                        In comparison, APIs using REST over HTTP don't maintain a connection to the client once the
                        server has replied to it.
                    </p>
                    <p>
                    ...
                    <p>
                        A client can also subscribe and receive several types of different information simultaneously
                    ...
                    <h2 id='json'>JSON</h2>
                    <p>
                        JavaScript Object Notation (JSON) is a data format based on JavaScript. However, it is
                        completely language-independent, and can be used by any modern programming language. JSON has a
                        good balance between being readable by humans and by machines, making it both user-friendly and
                        computer-efficient.
                    </p>
                    <p>
                ...
                <div className={styles.apiCodeBlock}>
                    <CodeBlockSingleLanguage lang='json' content={nestedContent} />
                </div>
                <p>
                ...
                <p>
                    ...
                    information (<code className='inline-code'>print authentication.identity.services.manual</code>)
                ...
                <p>
                    ...
                    users. In a nutshell, it’s a standardised way of explaining what a JSON request should look like
                    using JSON itself.
                </p>
                <p>
                    Here is an example of the part of the JSON Schema that is used to tell developers what to send when
                    they request the balance of an account:
                </p>
                <div className={styles.apiCodeBlock}>
                    <CodeBlockSingleLanguage lang='json' content={schemaContent} />
                </div>
                <p>
                ...
                <p>
                    JSON Schemas on Deriv are divided into schemas we accept (request) and schemas we send (response).
                    You can find the detailed JSON schemas for each API call on our{' '}
                ...
                <h3>API token</h3>
                <p>
                    An API token is a unique identifier of a client that requests access from a server. It's the
                    simplest way of authorisation.
                </p>
                <p>
                    The Deriv API token has to be generated by a client{' '}
                    <a href='https://app.deriv.com/account/api-token'>here</a>, along with setting the appropriate
                    access level.
                </p>
                <div className={styles.apiGuideImage}>
                ...
                <p>
                    The access level for each API token has to match the required access level of each API call, which
                    can be found in the <Link to='/api-explorer'>API Explorer</Link> as well.
                </p>
                <p>
                ...
                <p>
                    Please bear in mind that the API token can be used with any app, so both your app and your clients
                ...
                <p>
                    ...
                    <a href='https://aaronparecki.com/oauth-2-simplified/'>this guide</a>.
                </p>
                ...
                <ul>
                    <li>
                        <p>
                            ...
                            <a href='https://developers.binary.com/applications/'>API registration</a> page in the
                            'Website URL' field.
                        </p>
                    </li>
                    <li>
                        <p>
                            ...
                            <b>https://oauth.binary.com/oauth2/authorize?app_id=your_app_id</b> where your_app_id is the
                            ID of your app.
                        </p>
                    </li>
                </ul>
                ...
                <p>
                    Once a user signs up, they will be redirected to the URL that you entered as the Redirect URL. This
                    URL will have arguments added to it with the user's session tokens, and will look similar to this:
                </p>
                <p>
                ...
                <ul>
                    <li>
                        Pass these tokens to the Authorize API call in order to perform actions on behalf of the
                        account.
                    </li>
                </ul>
                ...
                <p>
                    ...
                    <Link to='/docs/'>quick start page</Link>.
                </p>
                <p>
                    However, while the simple example will work for most cases, it does not perform any checks to see if
                    the asset is available for purchase or show the potential payout if they proceed with the purchase.
                </p>
                <p>
                    To receive this additional information, you can perform several steps once you are authorised and
                    before purchasing the contract.
                </p>
                <ul>
                    <li>
                        Call <a href='/api-explorer#active_symbols'>Active Symbols</a> to get the list of active
                        symbols.
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        open a trade. Note the contract_id from the response. Setting “subscribe” : 1 will send you
                        updates on the contracts status as{' '}
                        <a href='/api-explorer#proposal_open_contract'>Proposal Open Contract</a> responses.
                    </li>
                    <li>
                        Monitor the <b>“is_sold”</b> attribute of the <b>Proposal Open Contract</b> response to see when
                        the contract is finished. Once the contract is finished, you can check the <b>“status”</b>{' '}
                        attribute to see if the contract has been won or lost.
                    </li>
                </ul>
                <h2 id='table-mapping'>Table mapping</h2>
                <h3>Deriv website contract types to API parameter names</h3>
                <p>
                    If you would like to copy certain contract types from our websites, the following table will
                    describe how the contract type is referred to using the API.
                </p>
                <div className={styles.apiGuideTableContainer}>
                    <ApiGuideTable />
                </div>
            </div>
        </div>
