        ...
        <React.Fragment>
            <div className={styles.textBlock}>
                ...
                <p>
                    ...
                    of our support forums or via <a href='mailto:api-support@deriv.com'>email</a>.
                </p>
            </div>
            <div className={styles.textBlock}>
            ...
            <p>
                ...
                information (<code className='inline-code'>print authentication.identity.services.manual</code>) about
            ...
            <p>
                ...
                can find the detailed JSON schemas for each API call on our <a href='/api-explorer/'>API Explorer</a>.
            </p>
            ...
            <p>
                ...
                <a href='https://app.deriv.com/account/api-token'>here</a>, along with setting the appropriate access
                level.
            </p>
            <div className={styles.apiGuideImage}>
            ...
            <p>
                ...
                be found in the <Link to='/api-explorer'>API Explorer</Link> as well.
            </p>
            <p>
            ...
            <ul>
                ...
                <li>
                    <p>
                        ...
                        <b>https://oauth.binary.com/oauth2/authorize?app_id=your_app_id</b> where your_app_id is the ID
                        of your app.
                    </p>
                </li>
            </ul>
            ...
            <ul>
                ...
                <li>
                    Call <a href='/api-explorer#buy'>Buy Contract</a> with the ID given in the Price Proposal to open a
                    trade. Note the contract_id from the response. Setting “subscribe” : 1 will send you updates on the
                    contracts status as <a href='/api-explorer#proposal_open_contract'>Proposal Open Contract</a>{' '}
                    responses.
                </li>
                <li>
                    Monitor the <b>“is_sold”</b> attribute of the <b>Proposal Open Contract</b> response to see when the
                    contract is finished. Once the contract is finished, you can check the <b>“status”</b> attribute to
