    ...
    const LastSlide = () => {
        return (
            <Slide
                content={
                    <span>
                        I have been using the Deriv API for 13 years to build successful apps in and I find the support
                        I get from Deriv as a business partner second to none. I look forward to 13 more successful
                        years to come.
                    </span>
                }
                author={
        ...
        <React.Fragment>
            <div className="main-page-row white">
                ...
                <div id='slider' className={`${styles.slider} loaded`}>
                    ...
                    <div id='prev' className={`${styles.control} ${styles.prev}`} onClick={() => nextOrPrevSlide(PREVIOUS)} />
                    <div id='next' className={`${styles.control} ${styles.next}`} onClick={() => nextOrPrevSlide(NEXT)} />
                </div>
            </div>
        </React.Fragment>
    );
