            ...
            <div className={styles.withBg}>
                ...
                <Accordion>
                    <AccordionItem title='What is the easiest way to get started with Deriv API?'>
                        <p>
                            View our <a href='https://api.deriv.com/docs/'>code samples</a>. You can use these code
                            snippets in your app to open a connection to our WebSocket API service. Explore our
                            <a href='/api-explorer/'> API explorer</a> for the method calls you need for your app.
                        </p>
                    </AccordionItem>
                    <AccordionItem title='How do I build my own front-end app?'>
                        ...
                        <ol>
                            ...
                            <li>
                                Download the <a href='https://desktop.github.com'>GitHub Desktop application</a>.
                            </li>
                            <li>
                                Fork any of our{' '}
                            ...
                            <li>
                                Publish your fork using the <a href='https://pages.github.com/'>GitHub Pages</a>{' '}
                                facility.
                            </li>
                            <li>
                    ...
                    <AccordionItem title='Can someone build an app for me?'>
                        <p>
                            Sure! You may hire developers who are familiar with JavaScript and WebSocket technology to
                            build your app for you.
                        </p>
                    </AccordionItem>
                    <AccordionItem title='Will I earn commissions if a client signed up with Deriv using my app?'>
                        ...
                        <ol>
                            <li>
                                Sign up as an <a href='https://deriv.com/partners/affiliate-ib/'>affiliate</a>.
                            </li>
                            <li>
                                Insert your affiliate token into the{' '}
                                <a href='/api-explorer/#new_account_virtual' passHref={true}>
                    ...
                    <AccordionItem title='How else can I earn?'>
                        ...
                        <ol>
                            <li>
                                Sign up as a <a href='https://deriv.com/partners/payment-agent/'>payment agent</a> to
                            ...
                            <li>
                                ...
                                <a href='/app-registration'> register</a> your app. This is a percentage of contract
                    ...
                    <AccordionItem title='What does it mean if a schema property has the ‘sensitive’ attribute?'>
                        This means we will treat the value of this property as confidential, and will never return it in
                        any API response. It is used for passwords and tokens.
                    </AccordionItem>
                    <AccordionItem title='What is copy trading?'>
                        ...
                        <p>
                            ...
                            <a href='/api-explorer#set_settings'>set settings</a> call.
                        </p>
                        ...
                        <p>
                            To start copying, use the <a href='/api-explorer/#copy_start'>copy start</a> call. To stop
                            copying, use <a href='/api-explorer/#copy_stop'>copy stop</a>.
                        </p>
                    </AccordionItem>
                    <AccordionItem title='How do I check for server status updates?'>
                        <p>
                            Use the <a href='/api-explorer/#website_status'>website status</a> call to check whether the
              ...
              `}
                    ...
                    <AccordionItem title='How do I get help?'>
                        Visit our <a href='https://binary.vanillacommunity.com/'>dev forum</a> or email
                        <a href='mailto:api-support@deriv.com?subject=API+Question:+'> api-support@deriv.com</a>.
                    </AccordionItem>
                </Accordion>
            </div>
        </div>
