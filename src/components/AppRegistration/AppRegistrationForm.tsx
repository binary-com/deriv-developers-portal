...
export default function AppRegistrationForm() {
  ...
  useEffect(() => {
    ...
    if (isUpdateMode) {
      ...
      setValue(
        "trading_information_scope",
        scopes.includes("trading_information") ? true : false
      );
  ...
  const registerButtonMessage = isUpdateMode
    ? "Update application"
          ...
          <div className={styles.expandableForm}>
            <fieldset>
              <div className={styles.formHeaderContainer}>
                ...
                <div className={styles.infoIcon}>
                  <div className={styles.tooltip}>
                    For each trade performed on your app, you will receive a
                    commission. Set a markup percentage below to determine the
                    commission you will make.
                  </div>
                  <div className={styles.infoIconImage} />
                </div>
              </div>
              ...
              <div className={styles.formHeaderContainer}>
                ...
                <div className={styles.infoIcon}>
                  <div className={styles.tooltip}>
                    To use OAuth, please fill out the following fields. These
                    details can be changed later using the app_update API call.
                  </div>
                  <div className={styles.infoIconImage} />
                </div>
              </div>
              <div className="input-container">
                  ...
                  <input
                    {...register("app_redirect_uri", {
                      ...
                      pattern: {
                        ...
                        message:
                          "Enter a valid URL. (Example: https://www.[yourname].com)",
                      },
                    })}
                    id="app_redirect_uri"
                    type="text"
                ...
                <p className={styles.helperText}>
                  *Please note that this URL will be used as the OAuth redirect
                  URL for the OAuth authorisation
                </p>
              </div>
              {errors.app_redirect_uri && (
                <span className="error-message">
                  {errors.app_redirect_uri.message}
                </span>
              )}
              <div className="input-container">
                <div className={styles.customTextInput} id="custom-text-input">
                  <input
                    {...register("app_verification_uri", {
                      ...
                      maxLength: {
                        value: 255,
                        message:
                          "Your verification URL cannot exceed 255 characters.",
                      },
                      pattern: {
                        value:
                          /^[a-z][a-z0-9.+-]*:\/\/[0-9a-zA-Z.-]+[%/\w .-]*$/,
              ...
              {errors.app_verification_uri && (
                <span className="error-message">
                  {errors.app_verification_uri.message}
                </span>
              )}
            </fieldset>
            <div className={styles.scopes} id="register_scopes">
              <div>
                <div className={styles.formHeaderContainer}>
                  <h4 className={styles.registerFormHeader}>
                    OAuth authorisation levels
                  </h4>
                  <div className={styles.infoIcon}>
                    <div className={styles.tooltip}>
                      Please select the level of access you would like clients
                      to give to your app.
                    </div>
                    <div className={styles.infoIconImage} />
                  </div>
                ...
                <p>
                  ...
                  <b>'Trading information'</b> access. <b>'Admin'</b> access is
              ...
              <div className={styles.scopesField}>
                ...
                <label htmlFor="read-scope">
                  Read all: Full access to users’ information, including private
                  information
                </label>
              </div>
              <div className={styles.scopesField}>
                ...
                <label htmlFor="trade-scope">
                  Trade: Buy and sell contracts on the users’ behalf
                </label>
              </div>
              <div className={styles.scopesField}>
                <div className={styles.customCheckboxContainer}>
                ...
                <label htmlFor="trading_information-scope">
                  Trading information: View users’ trading information,
              ...
              <div className={styles.scopesField}>
                ...
                <label htmlFor="payments-scope">
                  Payments: Cashier (deposit and withdrawal)
                </label>
              </div>
              <div className={`${styles.scopesField} mb-0`}>
                ...
                <label htmlFor="admin-scope">
                  Admin: Full account access, including the access to manage
                  security tokens
                </label>
              </div>
            </div>
            {errors.admin_scope && (
              <span className="error-message">
                {errors.admin_scope.message}
              </span>
            )}
            <div className={styles.termsOfConditionRegister}>
              <span>
                By registering your application, you acknowledge that you’ve
                read and accepted the Deriv API{" "}
              </span>
              <a
            ...
            <div className={styles.registerAppButtonContainer}>
              {isUpdateMode && (
                <Button
                  type="secondary"
                  onClick={() => stateService.send("REGISTER_TOGGLE_TAB")}
                >
                  Cancel
                </Button>
              )}
