...
const QuickStart = () => (
    ...
    </p><CodeBlock id={"authorize"} /><h2>Account balance</h2><p>
      This example shows you how to use the Deriv API to retrieve account
      balance information.
    </p><CodeBlock id={"balance"} /><h2>Active symbols</h2><p>
    ...
    </p><CodeBlock id={"active-symbols"} /><h2>Buy contract</h2><p>
    ...
    </p><CodeBlock id={"buy-contract"} /><h2>Contracts for symbol</h2><p>
    ...
    </p><CodeBlock id={"contracts-for-symbol"} /><h2>Ticks</h2><p>
    ...
    </p><SandboxIframe sandbox={sandboxes.ticks} /><h2>Ticks history</h2><p>
    ...
    </p><CodeBlock id={"ticks-history"} /><h2>Portfolio</h2><p>
      Receive information about your portfolio with outstanding options.
    </p><CodeBlock id={"portfolio"} /><h2>Profit table</h2><p>
      This example will retrieve a summary of your account Profit Table.
    </p><CodeBlock id={"profit-table"} /><h2>Proposal</h2><p>
    ...
    </p><CodeBlock id={"proposal"} /><h2>Proposal: Open contract</h2><p>
      Get latest price (and other information) for a contract in the user's portfolio.
    </p><CodeBlock id={"proposal-open-contract"} /><h2>Keep alive</h2><p>
    ...
    </p><CodeBlock id={"keep-alive"} /><h2>Sell expired contracts</h2><p>
      This call will try to sell any expired contracts and return the number of sold contracts.
    </p><CodeBlock id={"sell-expired-contracts"} /><h2>Statement</h2><p>
      Retrieve a summary of account transactions, according to given search criteria.
    </p><CodeBlock id={"statement"} /><h2>Website status</h2><p>
