...
const QuickStart = () => (
    <>
        <div className='page-content'>
            ...
            <div>
                <p>
                    On this page, you&#39;ll find code samples in various programming languages showing you how to work
                    with the Deriv API to perform some of the most important operations.
                </p>
                <p>
            ...
            <h2>Authorize</h2>
            <p>
                While not always the case, most of the functionalities of the Deriv API requires you to authorize first
                with an API token. This example shows how you can authorize before using specific functions. In more of
                the code examples below, you can see aswell how the authorize function is utilized.
            </p>
            ...
            <h2>Buy contract</h2>
            <p>
                A contract is an agreement to buy or sell an asset at an agreed-upon price. This example shows you how
                to buy a contract using Deriv API.
            </p>
            <CodeBlock id={'buy-contract'} />
            <h2>Ticks</h2>
            <p>
                A tick is a measure of minimum upward or downward movement in the price of a trading commodity. This
                example shows you how to collect ticks for your trading app using Deriv's API.
            </p>
            <CodeBlock id={'ticks'} />
            <h2>Ticks history</h2>
            <p>
                With ticks history you are able to make a collection of past ticks. It is also possible to subscribe to
                the websocket to keep track of the past ticks.
            </p>
            ...
            <h2>Proposal</h2>
            <p>
                This example is for getting a contract proposal. You'll be able to get the price, payout and spot value
                for your contract.
            </p>
            ...
            <h2>Keep alive</h2>
            <p>
                In this example you’ll see how to keep a connection alive when getting contract proposals via the Deriv
                API. This example keeps the connection alive by sending a ping every 30 seconds.
            </p>
        ...
        <p>
            Retrieve a list of all currently active symbols (underlying markets upon which contracts are available for
            trading).
        </p>
        <p>
            This example retrieves all avaiable active symbols. In case you want to retrieve active symbols for a
            specific landing company, you can add <code className='inline-code'>landing_company</code> to the request
            object.
        </p>
        ...
        <p>
            For a given symbol, get the list of currently available contracts, and the latest barrier and duration
        ...
        <p>Get latest price (and other information) for a contract in the user's portfolio.</p>
        ...
        <CodeBlock id={'sell-expired-contracts'} />
        <h2>Statement</h2>
        <p>Retrieve a summary of account transactions, according to given search criteria.</p>
        <CodeBlock id={'statement'} />
        <h2>Website status</h2>
        <p>
            Request the website status. From the API response you will be able to look into general settings like call
            limits, currencies information, supported languages and much more.
        </p>
