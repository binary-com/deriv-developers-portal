  ...
  return (
    <div className={styles.apiGuide}>
      ...
      <div className={styles.apiGuideContent}>
        ...
        <p>For example, when we send information about account status, it requires several levels to print information about the manual Identity service status:</p>
        ...
        <p>The following table maps Deriv website contract types to the API parameter names.</p>
